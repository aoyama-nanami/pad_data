...
from pad_data.active_skill.effect import *
...
_EFFECT_MAP = {
    ...
    7: Map(Heal, rcv_percentage=int, bind=0, hp_value=0, hp_percentage=0,
           awoken_bind=0),
    8: Map(Heal, hp_value=int, bind=0, rcv_percentage=0, hp_percentage=0,
           awoken_bind=0),
    ...
    50: Map(ElementDamageBuff, duration=int, cond=[Orb], percentage=int),
    ...
    88: Map(TypeDamageBuff, duration=int, cond=[Type], percentage=int),
    90: Map(ElementDamageBuff, duration=int, cond=[Orb, Orb], percentage=int),
    91: Map(OrbEnhance, orbs=[Orb, Orb], unused=int),
    92: Map(TypeDamageBuff, duration=int, cond=[Type, Type], percentage=int),
    93: Map(LeaderSwap),
    ...
    115: Map(AtkNuke, target=Target.ONE, element=Orb, percentage=int,
             leech=int),
    117: Map(Heal, bind=int, rcv_percentage=int, hp_value=int,
    ...
    179: Map(HealOverTime, duration=int, unused=int, hp_percentage=int,
