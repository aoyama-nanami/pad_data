...
_EFFECT_MAP = {
    0: Map(AtkBasedDamage, element=Orb, percentage=int, target=Target.ALL),
    1: Map(FixedValueDamage, element=Orb, value=int, target=Target.ALL),
    2: Map(AtkBasedDamage, element=Orb.NO_ORB, percentage=int,
    ...
    55: Map(FixedValueDamage, target=Target.ONE, element=Orb.NO_ORB,
            ignore_def=True, value=int),
    56: Map(FixedValueDamage, target=Target.ALL, element=Orb.NO_ORB,
            ignore_def=True, value=int),
    58: Map(AtkBasedDamage, target=Target.ALL, element=Orb,
            percentage=[int, int]),
    59: Map(AtkBasedDamage, target=Target.ONE, element=Orb,
            percentage=[int, int]),
    60: Map(Counter, duration=int, percentage=int, element=Orb),
    71: Map(AllOrbChange, orbs=_consume_all_args(Orb, -1)),
    84: Map(AtkBasedDamage, target=Target.ONE, element=Orb,
            percentage=[int, int], hp_remain=int),
    85: Map(AtkBasedDamage, target=Target.ONE, element=Orb,
            percentage=[int, int], hp_remain=int),
    86: Map(FixedValueDamage, element=Orb, value=int, unused=int,
            hp_remain=int, target=Target.ONE),
    87: Map(FixedValueDamage, element=Orb, value=int, unused=int,
    ...
    115: Map(AtkBasedDamage, target=Target.ONE, element=Orb, percentage=int,
             leech=int),
    ...
    143: Map(TeamHpBasedDamage, percentage=int, element=Orb,
             target=Target.ALL),
    144: Map(TeamAtkBasedDamage, base_elem=orb_list, percentage=int,
    ...
    188: Map(FixedValueDamage, target=Target.ONE, element=Orb.NO_ORB,
             ignore_def=True, value=int),
    189: Map(ComboHelper),
