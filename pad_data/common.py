...
class Card:
    ...
    def atk_at_level(self, level):
        return self._stat_at_level(level, 'atk')

    def hp_at_level(self, level):
        return self._stat_at_level(level, 'hp')

    def rcv_at_level(self, level):
        return self._stat_at_level(level, 'rcv')
